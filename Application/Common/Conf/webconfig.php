...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '浙ICP备19052071号-1',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  'baijunyao@baijunyao.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  'LXJ健康快乐',             //网站名：
    'WEB_KEYWORDS'              =>  'LXJ,帅白,技术博客,个人博客,lxjblog',         //网站关键字
    'WEB_DESCRIPTION'           =>  'LXJ的个人技术博客,lxjblog官方网站',      //网站描述
    'AUTHOR'                    =>  'LXJ',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为白俊遥原创文章,转载无需和我联系,但请注明来自白俊遥博客baijunyao.com',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  'LXJ健康快乐', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'lxj96.cn',      //文字水印内容
